...
@section('content')
    ...
    >
        ...
        <div class="field">
            <div class="control">
                <button type="submit" class="bg-transparent hover:bg-grey-darkest text-grey-darkest hover:text-white py-1 px-2 border border-grey-darkest hover:border-transparent rounded">Register</button>
            </div>
        </div>
    </form>
@endsection