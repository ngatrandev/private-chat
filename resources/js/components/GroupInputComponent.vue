<template>
    ...
    class="w-full flex font-serif">
        ...
        <form class="flex w-full border-b-2  border-teal " @submit.prevent="send" @keydown="type">
            <input 
            v-model="text"
            class=" emotion appearance-none text-base shadow  w-full py-1 px-3 text-grey-darker leading-tight focus:outline-none" id="username" type="text" placeholder="Enter your message">
        </form>
