<template>
    <div class="w-full flex bg-grey-light font-serif py-2">
        ...
        >
        <svg class="h-4 mt-2 fill-current " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M15 3H7a7 7 0 1 0 0 14h8v-2H7A5 5 0 0 1 7 5h8a3 3 0 0 1 0 6H7a1 1 0 0 1 0-2h8V7H7a3 3 0 1 0 0 6h8a5 5 0 0 0 0-10z"/></svg>
        </file-upload>
        <div @click.prevent="emotion" class="cursor-pointer text-green hover:text-red">
            <svg class=" ml-2 mt-2  h-4 fill-current " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 20a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zM6.5 9a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm7 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zM7 13h6a1 1 0 0 1 0 2H7a1 1 0 0 1 0-2z"/></svg>
        </div>
        ...
        <picker v-if="emoStatus" :data="emojiIndex" set="emojione"  @select="addEmotion" emoji="point_up"  title="Pick your emoji..." :style="{ position: 'absolute', bottom: '15px', left: '15px' }" :i18n="{ search: 'Recherche', categories: { search: 'Résultats de recherche', recent: 'Récents' } }" />
    </div>
</template>
